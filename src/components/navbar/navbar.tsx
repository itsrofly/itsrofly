                    ...
                    <ul class="navbar-nav ms-auto me-4 mb-2" >
                        <li class="nav-item">
                            <a class="nav-link" href="/blog">
                                <span class="secondary-color">Blog</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/#Projects">
                                <span class="secondary-color">Projects</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="mailto:contact@itsrofly.com">
                                <span class="secondary-color">Contact</span>
                            </a>
                        </li>
                        <li class="nav-item ms-3">
                            <a class="nav-link" href="https://github.com/itsrofly">
